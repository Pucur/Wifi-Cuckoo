...
This code is provided as a sample only; you can choose the license for further use and modification (for example, MIT or GPLv3).  
If you want, just add a `LICENSE` file alongside this README. 📂
